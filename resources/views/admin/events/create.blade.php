...
@section('main')
    <div class="container-fluid">
        <form action="{{ route('admin.events.store') }}" method="POST" id="form" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <input type="number" class="form-control" id="kuota" name="kuota"
                                        placeholder="kuota" value="{{ old('kuota') }}" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <select name="jenis_event" id="jenis_event" class="form-control" required>
                                        <option value="gratis" {{ old('jenis_event') == 'gratis' ? 'selected' : '' }}>
                                            Gratis</option>
                                        <option value="berbayar" {{ old('jenis_event') == 'berbayar' ? 'selected' : '' }}>
                                            Berbayar</option>
                                    </select>
                                </div>
                            </div>

                            <div class="form-group row show_biaya" style="display: none;">
                                <label for="biaya" class="col-sm-2 col-form-label">Biaya Pendaftaran<b
                                        class="text-danger">*</b></label>
                                <div class="col-sm-6 controls">
                                    <input type="number" class="form-control" id="biaya" name="biaya"
                                        placeholder="biaya" value="{{ old('biaya') }}" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <input type="datetime-local" class="form-control" id="waktu_mulai" name="waktu_mulai"
                                        placeholder="waktu_mulai" value="{{ old('waktu_mulai') }}" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <select name="status_event" id="status_event" class="form-control" required>
                                        <option value="aktif" {{ old('status_event') == 'aktif' ? 'selected' : '' }}>
                                            Aktif</option>
                                        <option value="tidak aktif"
                                            {{ old('status_event') == 'tidak aktif' ? 'selected' : '' }}>
                                            Tidak aktif</option>
                                    </select>
                                </div>
                            </div>
