                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <input type="number" class="form-control" id="telp" name="telp"
                                        placeholder="No.Telp/WA" value="{{ old('telp') }}" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <input type="text" class="form-control" id="prodi" name="prodi"
                                        placeholder="Prodi" value="{{ old('prodi') }}" />
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6 controls">
                                    <select name="status" id="status" class="form-control" required>
                                        <option value="mahasiswa" {{ old('status') == 'mahasiswa' ? 'selected' : '' }}>
                                            Mahasiswa</option>
                                        <option value="dosen" {{ old('status') == 'dosen' ? 'selected' : '' }}>
                                            Dosen</option>
                                        <option value="umum" {{ old('status') == 'umum' ? 'selected' : '' }}>
                                            Umum</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <select name="role" id="role" class="form-control" required>
                                        <option value="pendaftar" {{ old('role') == 'pendaftar' ? 'selected' : '' }}>
                                            Pendaftar</option>
