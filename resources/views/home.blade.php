        ...
        @foreach ($data as $row)
            ...
            <div class="col-lg-4">
                <div class="card" style="width: 100%;">
                    <img class="card-img-top" style="height: 300px; object-fit: cover;" src="{{ asset($row->gambar) }}"
                        alt="Poster">
                    <div class="card-body">
            ...
            $.ajax({
                ...
                if (response.status) {
                    ...
                    if (event.status_daftar) {
                        $('.show-button-event').html(`<a href="{{ url('detail-pendaftaran-event') }}/${id}" class="btn btn-info btn-block link-pendaftaran" style="opacity: 0.6;"><i
